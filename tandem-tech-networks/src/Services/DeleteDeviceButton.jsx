...
const DeleteDeviceButton = ({ deviceId }) => {
    ...
    const handleDeviceDeletion = async () => {
        if (window.confirm("Are you sure you want to delete this device from your account?")) {
            try {
                ...
                console.error("Failed to delete device: ", error.response ? error.response.data : "no response");
